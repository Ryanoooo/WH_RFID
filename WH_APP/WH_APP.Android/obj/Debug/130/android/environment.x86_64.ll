...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"ebf57128-2f96-4f86-849e-99a90b824620\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [23 x i8] c"com.companyname.wh_app\00", align 16
...
@__DSOCacheEntry_name.3 = internal constant [13 x i8] c"libSTUHFL.so\00", align 1
...
@__DSOCacheEntry_name.6 = internal constant [14 x i8] c"librfidapi.so\00", align 1
...
@__DSOCacheEntry_name.10 = internal constant [16 x i8] c"libJNISTUHFL.so\00", align 16
...
@dso_cache = local_unnamed_addr global [40 x %struct.DSOCacheEntry] [
	...
	; 2
	%struct.DSOCacheEntry {
		i64 2196784371985450950, ; hash 0x1e7c8bbf4c5287c6, from name: libSTUHFL
		i8 0, ; ignore
	...
	; 7
	%struct.DSOCacheEntry {
		i64 5541773019315550030, ; hash 0x4ce855331225b74e, from name: rfidapi.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 8
	%struct.DSOCacheEntry {
	...
	; 9
	%struct.DSOCacheEntry {
		i64 6925533971786285185, ; hash 0x601c70744c38c081, from name: STUHFL.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 12
	%struct.DSOCacheEntry {
		i64 7463318074814324860, ; hash 0x6793083f270f607c, from name: librfidapi
		i8 0, ; ignore
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 16
	%struct.DSOCacheEntry {
		i64 8044478481569358524, ; hash 0x6fa3ba8eb93722bc, from name: libJNISTUHFL
		i8 0, ; ignore
	...
	; 17
	%struct.DSOCacheEntry {
		i64 8147329342654601885, ; hash 0x711120dee90b5a9d, from name: librfidapi.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 20
	%struct.DSOCacheEntry {
		i64 8939447001327786518, ; hash 0x7c0f4baf3a92da16, from name: STUHFL
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 28
	%struct.DSOCacheEntry {
		i64 14179256473530861340, ; hash 0xc4c6d6a343f7071c, from name: rfidapi
		i8 0, ; ignore
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 31
	%struct.DSOCacheEntry {
		i64 14852297365330029326, ; hash 0xce1df5c34ef76b0e, from name: JNISTUHFL.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 32
	%struct.DSOCacheEntry {
		i64 14871145707472359325, ; hash 0xce60ec3af0f70f9d, from name: JNISTUHFL
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 33
	%struct.DSOCacheEntry {
		i64 15460093445898323974, ; hash 0xd68d4913f51d4806, from name: libSTUHFL.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 37
	%struct.DSOCacheEntry {
		i64 17507981072624558885, ; hash 0xf2f8d806380ca325, from name: libJNISTUHFL.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
